...
y_pred_ann = np.zeros(100, dtype=np.int64)
y_pred_snn = np.zeros(100, dtype=np.int64)
...
print("ANN Accuracy on subset:", accuracy_score(y[:100], y_pred_ann))
print("SNN Accuracy on subset:", accuracy_score(y[:100], y_pred_snn))
