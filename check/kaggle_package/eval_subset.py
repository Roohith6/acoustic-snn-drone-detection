...
def eval_range(start, end, clamp=True):
    y_pred = []
    ...
    print(f"Clamp={clamp} Accuracy:", accuracy_score(y[start:end], y_pred))

print("Testing ambient files 2000 to 2100")
eval_range(2000, 2100, clamp=True)
eval_range(2000, 2100, clamp=False)
