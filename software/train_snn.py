...
if __name__ == "__main__":
    ...
    # currently-shipped W1/W2 -- net.b1/net.b2 are trained by Adam above
    # exactly like the weights, but were never previously written out) ---
    export_weights_for_verilog(net.b1.reshape(1, -1), os.path.join(out_dir, "b1_hidden.mem"))
    export_weights_for_verilog(net.b2.reshape(1, -1), os.path.join(out_dir, "b2_output.mem"))
    np.save(os.path.join(out_dir, "b1_raw.npy"), net.b1)
    np.save(os.path.join(out_dir, "b2_raw.npy"), net.b2)
