...
DATASET_PATH = "E:/snn_2/DroneAudioDataset/Binary_Drone_Audio"
...
for i in range(100):
    ...
    for t in range(50):
        ...
        # REMOVED: v_hid = np.maximum(0, v_hid) # ALLOW HYPERPOLARIZATION!
        ...
        # REMOVED: v_out = np.maximum(0, v_out)
        
    y_pred.append(1 if out_spikes[1] > out_spikes[0] else 0)

from sklearn.metrics import accuracy_score
print("Accuracy on subset without floor clamping:", accuracy_score(y[:100], y_pred))
